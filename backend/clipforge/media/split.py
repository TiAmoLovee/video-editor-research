...
def split_video(video_path: str, output_dir: str, ffmpeg: str | None = None,
                ffprobe: str | None = None, timeout: int = 3600) -> dict:
    ffmpeg = media_tool("ffmpeg", ffmpeg)
    ffprobe = media_tool("ffprobe", ffprobe)
