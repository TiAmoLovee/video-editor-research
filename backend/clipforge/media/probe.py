...
def probe_video(video_path: str, ffprobe_path: str | None = None) -> dict:
    ...
    try:
        ...
        raise RuntimeError("找不到 FFprobe，请设置 FFPROBE 环境变量或通过 --ffprobe 指定程序路径。") from exc
...
def main() -> int:
    ...
    parser.add_argument("--ffprobe", default=None, help="FFprobe 程序路径")
